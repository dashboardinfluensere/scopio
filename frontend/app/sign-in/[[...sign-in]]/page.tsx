          ...
          <div className="hidden flex-col justify-between bg-[#0F172A] p-10 text-white lg:flex">
            <div>
              ...
              <h1 className="mt-6 max-w-md text-4xl font-semibold leading-tight">
                Én plass for oversikt over innhold, vekst og kontoer.
              </h1>
              <p className="mt-4 max-w-md text-sm leading-6 text-[#CBD5E1]">
                Logg inn for å følge kontoer, bytte workspace og få oversikt over
                ytelse på tvers av plattformer.
              </p>
            </div>

            <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
              <p className="text-sm text-[#E2E8F0]">
                Bygd for creators, byråer og team som vil ha et rent dashboard
                uten støy.
              </p>
            </div>
          </div>
